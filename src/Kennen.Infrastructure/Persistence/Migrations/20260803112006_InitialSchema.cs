        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkArrangement = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_stat_metrics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorInitials = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_content_items_content_sections_ContentSectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverLetter = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: true),
                    ResumeFileName = table.Column<string>(type: "character varying(260)", maxLength: 260, nullable: false),
                    ResumeStorageKey = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    ResumeContentType = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_job_applications_job_postings_JobPostingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_content_items_ContentSectionId_DisplayOrder",
                table: "content_items",
                columns: new[] { "ContentSectionId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_content_sections_Key",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_job_applications_JobPostingId_Email",
                table: "job_applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_job_postings_IsPublished_PublishedAtUtc",
                table: "job_postings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stat_metrics_DisplayOrder",
                table: "stat_metrics",
                column: "DisplayOrder");
